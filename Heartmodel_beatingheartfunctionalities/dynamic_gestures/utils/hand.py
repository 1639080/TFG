#based on velocity movement, or bounding box change, it sets the position using one of the enum values. Then, value gets stored in a history list like self.position_history. 
class Hand:
