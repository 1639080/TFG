...
class Heart:
    def __init__(self, app, pos=(0, 0, 0), rot=(0, 0, 0), scale=(1, 1, 1), ppm=60, mask=[1]):
        ...
        self.vertex_data = self.get_vertex_data('Heartmodel/objects/heart/base.obj')
        self.texture = self.get_texture('Heartmodel/objects/heart/texture_diffuse.png')
        ...
        self.end_vertices_step1 = self.get_vertex_data('Heartmodel/objects/heart/updated_abaix.obj')
        self.end_vertices_step2 = self.get_vertex_data('Heartmodel/objects/heart/updated_ventricula.obj')
        self.end_vertices_step3 = self.get_vertex_data('Heartmodel/objects/heart/updated_arterias.obj')
